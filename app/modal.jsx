...
import { View, Text, TextInput, StyleSheet, Alert, TouchableOpacity, FlatList, Keyboard, Dimensions } from 'react-native';
...
export default function WorkoutModal() {
    ...
    const { date, workoutId } = useLocalSearchParams();
    ...
    const handleSubmit = async () => {
        try {
            if (!workoutName) {
                Alert.alert("Este necesar numele antrenamentului");
                return;
            }
            ...
            if (!currentWorkoutId) {
                ...
                currentWorkoutId = result.lastInsertRowId;
            } else {
                await db.runAsync(
            ...
            for (const input of exerciseInputs) {
                ...
                await db.runAsync(
                    ...
                    [currentWorkoutId, exerciseId, type, setsJson, durationInSeconds]
                );
            }
        ...
        <View style={styles.container}>
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>
                    {workoutId ? 'Editează antrenament ' : 'Creează antrenament'}
                </Text>
            </View>

            <View style={styles.card}>
                <Text style={styles.label}>Numele antrenamentului</Text>
                <TextInput
                    style={styles.input}
            ...
            <FlatList
                ...
                ListFooterComponent={
                    <>
                        ...
                        >
                            <Text style={styles.saveButtonText}>Salvează antrenamentul</Text>
                        </TouchableOpacity>
                    </>
                }
